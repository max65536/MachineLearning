...
for i in range(num):
    print("i=",i,"   likelihood=",logLikelihood[i])
# plot result
plt.subplot()
...
img = im2double(misc.imread('street.jpg'))
plt.imshow(img)
...
# for skin_K in range(4,6):
# skin_K=4
# thetalist=[1,10,30,50]
# for theta in thetalist:
# # theta=1
#     skin = skinDetection(ndata, sdata, skin_K, skin_n_iter, skin_epsilon, theta, img)
#     misc.imsave('street_k{0}_theta{1}.png'.format(skin_K,theta), skin)
